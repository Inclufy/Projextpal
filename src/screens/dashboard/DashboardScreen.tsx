...
const styles = StyleSheet.create({
  ...
  actionLabel: { fontSize: 12, color: '#1f2937', textAlign: 'center', fontWeight: '500' },
  ...
  comingSoonText: { fontSize: 11, fontWeight: 'bold', color: 'white' },
  ...
  freeBadgeTextLuxe: { fontSize: 11, fontWeight: 'bold', color: '#16A34A' },
