  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={['#3B82F6', '#8B5CF6']} style={styles.header}>
        ...
        <Text style={styles.title}>Privacy & Beveiliging</Text>
        <View style={{ width: 40 }} />
      </LinearGradient>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.placeholderCard}>
          ...
          <Text style={styles.placeholderTitle}>Privacy & Beveiliging</Text>
          <Text style={styles.placeholderText}>
            Beheer hier binnenkort uw privacy-instellingen, accountbeveiliging, twee-factor-authenticatie en gegevensvoorkeuren.
          </Text>
        </View>
      </ScrollView>
    </View>
