 ...
 * a callback. Mirrors the ProjeXtPal "Probleem melden" flow on the web
 * (commit 589c55d6) but triggered hands-free on mobile.
 *
 * Algorithm: 100 ms accelerometer sample, fires when ≥2 spikes above 1.8 g
 * arrive within a 700 ms window. 2 s cooldown afterwards to avoid bursts.
 */
