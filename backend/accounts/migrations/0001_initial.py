    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Super Admin'), ('admin', 'Administrator'), ('pm', 'Project Manager'), ('contibuter', 'Contibuter'), ('reviewer', 'Reviewer'), ('guest', 'Guest')], default='superadmin', max_length=100)),
