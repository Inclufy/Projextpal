...
router.register(r'meeting-attendees', views.MeetingAttendeeViewSet, basename='meeting-attendees')
router.register(r'meeting-action-items', views.MeetingActionItemViewSet, basename='meeting-action-items')
