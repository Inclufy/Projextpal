...
router.register(r'tasks', LSSBlackTaskViewSet, basename='lss-black-task')
...
project_router.register(r'tasks', LSSBlackTaskViewSet, basename='project-lss-black-task')
