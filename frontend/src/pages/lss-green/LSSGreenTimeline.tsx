  ...
  return (
    <div className="min-h-full bg-background">
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center gap-3"><Calendar className="h-6 w-6 text-green-500" /><h1 className="text-2xl font-bold">{pt("Timeline")}</h1></div>
...
export default LSSGreenTimeline;
