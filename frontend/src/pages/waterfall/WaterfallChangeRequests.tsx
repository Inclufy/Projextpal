...
const WaterfallChangeRequests = () => {
  ...
  const [form, setForm] = useState({ title: "", description: "", reason: "", scope_impact: "", priority: "medium" });
  ...
  const openCreate = () => { setEditing(null); setForm({ title: "", description: "", reason: "", scope_impact: "", priority: "medium" }); setDialogOpen(true); };
  const openEdit = (i: any) => { setEditing(i); setForm({ title: i.title || "", description: i.description || "", reason: i.reason || "", scope_impact: i.scope_impact || "", priority: i.priority || "medium" }); setDialogOpen(true); };
