              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="flex items-center gap-1 text-foreground hover:text-primary transition-colors font-medium">
                    ...
                    Academy
                    <Badge className="ml-1 text-[10px] px-1.5 py-0" style={{ backgroundColor: BRAND.green }}>Nieuw</Badge>
                ...
                <DropdownMenuContent align="start" className="w-80 p-2">
                  {academyItems.map((item, i) => (
                    <DropdownMenuItem 
                      ...
                      className="flex items-start gap-3 p-3 cursor-pointer rounded-xl hover:bg-muted/50 focus:bg-muted/50"
                    >
                      <div 
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-medium flex items-center gap-2">
                          {item.label}
                          {item.isNew && (
                            <span className="px-1.5 py-0.5 text-[10px] rounded-full font-medium" style={{ backgroundColor: `${BRAND.green}20`, color: BRAND.green }}>
                              Nieuw
                            </span>
                          )}
                        </div>
                  ...
                  <DropdownMenuItem 
                    ...
                    className="flex items-center gap-3 p-3 cursor-pointer rounded-xl hover:bg-muted/50"
                  >
...
const Hero = () => {
    ...
    try {
      const response = await fetch('http://localhost:8001/api/v1/bot/public/', {
        ...
        body: JSON.stringify({ 
          message: msgToSend,
          history: chatHistory,
          context: 'sales' // Indicate this is a sales context
        }),
      });
      ...
      if (data.success && data.reply) {
        ...
        setChatHistory(prev => [...prev, { role: 'assistant', content: isNL ? 'Bedankt voor je interesse! Neem contact op via hello@projextpal.com voor meer informatie.' : 'Thanks for your interest! Contact hello@projextpal.com for more information.' }]);
      }
    } catch (error) {
  ...
  return (
    <section id="home" className="pt-32 pb-20 relative overflow-hidden min-h-screen" style={{ background: `linear-gradient(180deg, ${BRAND.purple}06 0%, transparent 40%, ${BRAND.pink}04 100%)` }}>
      {/* Dynamic Animated Background - Project Scenarios */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* LEFT SIDE - Project Illustrations */}
        ...
        <svg className="absolute inset-0 w-full h-full opacity-[0.07]" preserveAspectRatio="none">
          ...
          <path d="M 5% 25% Q 25% 40% 50% 35% T 95% 50%" stroke="url(#lineGrad)" strokeWidth="2" fill="none" strokeDasharray="8,12" />
          <path d="M 10% 70% Q 35% 55% 55% 65% T 90% 45%" stroke="url(#lineGrad)" strokeWidth="2" fill="none" strokeDasharray="6,10" />
        </svg>
      </div>
        ...
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          >
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="gap-2 text-base px-8 h-14 rounded-2xl hover-lift animate-border-glow"
                  ...
                  >
                    ...
                    >
                      <p className="text-sm font-medium mb-3">
                        👋 {isNL ? 'Welkom bij ProjeXtPal! Ik help je graag met:' : 'Welcome to ProjeXtPal! I\'m happy to help with:'}
                      </p>
                      ...
                      <div className="mt-4 pt-3 border-t" style={{ borderColor: `${BRAND.purple}15` }}>
                        <p className="text-xs text-muted-foreground flex items-center gap-1">
                          <Sparkles className="w-3 h-3" style={{ color: BRAND.green }} />
                          {isNL ? 'Powered by AI • Gemiddelde responstijd: 2 sec' : 'Powered by AI • Average response: 2 sec'}
                        </p>
                      </div>
                    </div>
                  </div>

                  {/* Quick Prompts - Sales focused */}
                  <div 
          ...
          <div className="bg-card rounded-3xl border shadow-2xl overflow-hidden">
            ...
            <div className="p-6 bg-gradient-to-br from-background to-muted/20">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-card rounded-xl p-4 border">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-muted-foreground">{t.app.timeTracking}</span>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span>hello@projextpal.com</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="p-3 rounded-xl" style={{ backgroundColor: `${BRAND.purple}15` }}>
