...
import { NavLink, Outlet, useLocation, Navigate, useNavigate } from 'react-router-dom';  // ADD useNavigate
import {
  LayoutDashboard,
  Users,
  Building2,
...
const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Plans & Pricing',        // ← ADDED
        titleNL: 'Abonnementen',          // ← ADDED
        href: '/admin/plans',             // ← ADDED
      ...
      titleNL: 'Cursus Bouwer',
      href: '/admin/course-builder',
      icon: Layers,  // ← Import Layers bovenaan!
      },
      {
        title: 'Invoices',
        titleNL: 'Facturen',
...
export default function AdminPortalLayout() {
  ...
  // For development: allow access without SuperAdmin check
