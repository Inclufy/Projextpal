// ============================================================
// ORGANIZATION MANAGEMENT - PRODUCTION VERSION
// With Billing Cycle & Payment Method Support
// ============================================================
...
export default function OrganizationManagement() {
  ...
  const openEditDialog = (org: Organization) => {
    ...
    // Find current plan ID if exists
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="past_due">
                        <span className="flex items-center gap-2">
                          ...
                          {isNL ? 'Achterstallig' : 'Past Due'}
                        </span>
                      </SelectItem>
                      <SelectItem value="canceled">
                        <span className="flex items-center gap-2">
                          <span className="h-2 w-2 rounded-full bg-red-500" />
                          {isNL ? 'Geannuleerd' : 'Canceled'}
                        </span>
                      </SelectItem>
                    </SelectContent>
                  </Select>
