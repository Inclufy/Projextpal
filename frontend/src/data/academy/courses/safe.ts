...
export const safeCourse: Course = {
  ...
  description: 'Learn the concepts of the Scaled Agile Framework (SAFe) — ARTs, PI Planning, and Value Streams — to coordinate Agile at enterprise scale. Concepts-only: the in-app SAFe tooling (PI board) is still in development.',
  descriptionNL: 'Leer de concepten van het Scaled Agile Framework (SAFe) — ARTs, PI Planning en Waardestromen — om Agile op enterprise-schaal te coördineren. Alleen concepten: de SAFe-tooling in de app (PI-board) is nog in ontwikkeling.',
  icon: Rocket,
  color: BRAND.pink,
  ...
  certificate: true,
  conceptsOnly: true,
  conceptsNote: 'This course teaches SAFe concepts. The matching in-app tooling (PI board, ART execution) is still in development — see the SAFe program dashboard for the current preview.',
  conceptsNoteNL: 'Deze cursus behandelt SAFe-concepten. De bijbehorende tooling in de app (PI-board, ART-uitvoering) is nog in ontwikkeling — zie het SAFe-programmadashboard voor de huidige preview.',
  whatYouLearn: [
