      ...
      quiz: [
        {
          ...
          questionEN: 'What makes something NOT a project?',
          optionsEN: [
            'It is temporary',
            'It delivers a unique result',
            'It is an ongoing, repetitive activity',
            'It has a clear beginning and end',
          ],
          explanationEN: 'An ongoing, repetitive activity is an operation, not a project. Projects are by definition temporary and deliver unique results.',
        },
        {
          id: 'q2',
          ...
          questionEN: 'Which three factors make up the "Triple Constraint"?',
          optionsEN: [
          ...
          explanationEN: 'The Triple Constraint consists of Scope, Time, and Budget. These three factors are interconnected and affect one another.',
        },
        {
          id: 'q3',
          ...
          questionEN: 'Which methodology is most suitable for a project with uncertain, changing requirements?',
          optionsEN: [
            'Waterfall',
            'PRINCE2',
            'Agile',
          ...
          explanationEN: 'Agile is designed for situations with uncertainty and change. It works in short iterations and embraces change.',
        },
        {
          id: 'q4',
          ...
          questionEN: 'In which phase is the project charter created?',
          optionsEN: [
            'Planning',
            'Initiation',
            'Execution',
          ...
          explanationEN: 'The project charter is created in the Initiation phase. It is one of the first formal documents of a project.',
        },
        {
          id: 'q5',
          ...
          questionEN: 'What sits at the CENTRE of the Triple Constraint triangle (Iron Triangle)?',
          optionsEN: [
            'Scope',
            'Risk',
            'Quality',
          ...
          explanationEN: 'Quality sits at the centre of the Triple Constraint triangle. The three sides are Scope, Time, and Budget. Pulling on one side affects the other sides and the quality at the centre.',
        },
        {
          id: 'q6',
          ...
          questionEN: 'Which phase is often neglected but is crucial for organizational learning?',
          optionsEN: [
            'Initiation',
            'Planning',
            'Execution',
          ...
          explanationEN: 'The Closure phase is often skipped, but is crucial for documenting lessons learned and releasing resources.',
        },
        {
          id: 'q7',
          ...
          questionEN: 'Which characteristic most distinguishes the Waterfall methodology from Agile?',
          optionsEN: [
            'Waterfall is exclusively for software projects',
            'Waterfall has no planning phase',
            'Waterfall works in short iterations with continuous feedback',
            'In Waterfall, each phase must be fully completed before the next one begins',
          ],
          explanationEN: 'Waterfall is a sequential approach in which each phase (such as analysis, design, build, test) must be fully completed before the next phase starts. This differs fundamentally from Agile, which works iteratively with short cycles and continuous feedback.',
        },
        {
          id: 'q8',
          ...
          questionEN: 'What is "scope creep"?',
          optionsEN: [
            'The planned expansion of the project scope',
            'Uncontrolled, unapproved expansion of the scope',
            'Shrinking the scope to save budget',
            'A method for defining scope',
          ],
          explanationEN: 'Scope creep is the uncontrolled expansion of the project scope without adjusting time or budget. It is a common project risk.',
        },
        {
          id: 'q9',
          ...
          questionEN: 'Which skill does research often identify as decisive for PM success?',
          optionsEN: [
            'Technical expertise',
            'Budgeting skill',
          ...
          explanationEN: 'Although all skills are important, soft skills such as communication and leadership are often found to be decisive for project success.',
        },
        {
          id: 'q10',
          ...
          questionEN: 'What is a "gate review"?',
          optionsEN: [
            'A review of the project entrance',
            'A decision point between project phases',
            'A review of the project budget',
            'A daily team meeting',
          ],
          explanationEN: 'A gate review is a formal decision point between project phases where it is determined whether the project may proceed to the next phase.',
        },
      ],
    },
  ],
      ...
      quiz: [
        {
          ...
          questionEN: 'In which of Tuckman\'s stages do most conflicts arise?',
          optionsEN: [
            'Forming',
            'Storming',
            'Norming',
          ...
          explanationEN: 'In the Storming stage, working styles clash and conflicts arise over roles and positions. This is a normal stage in team development.',
        },
        {
          id: 'q-m4-2',
          ...
          questionEN: 'What is the best conflict style for an important issue when you have time?',
          optionsEN: [
            'Competing',
            'Avoiding',
            'Compromising',
          ...
          explanationEN: 'Collaborating leads to a win-win outcome and is ideal for important issues when you have the time to work together towards a solution.',
        },
        {
          id: 'q-m4-3',
          ...
          questionEN: 'EV = €40,000, PV = €50,000, AC = €55,000. What is the Schedule Variance?',
          optionsEN: [
            '+€10,000',
            '-€10,000',
            '+€15,000',
          ...
          explanationEN: 'Schedule Variance (SV) = EV - PV = €40,000 - €50,000 = -€10,000. Negative means behind schedule.',
        },
        {
          id: 'q-m4-4',
          ...
          questionEN: 'A CPI of 0.8 means:',
          optionsEN: [
            'You get €0.80 of value for every €1 spent',
            'You are 80% done with the project',
            'You are 20% under budget',
            'You are 80% ahead of schedule',
          ],
          explanationEN: 'CPI = EV/AC. A CPI of 0.8 means that for every €1 you spend, you receive only €0.80 in value. You are over budget.',
        },
        {
          id: 'q-m4-5',
          ...
          questionEN: 'What is "gold plating" in project management?',
          optionsEN: [
            'Successfully completing the project',
            'Adding extra features that were not requested',
            'Giving premium customers special treatment',
            'Exceeding quality standards',
          ],
          explanationEN: 'Gold plating is adding extra functionality or features that were not requested by the client. This is just as harmful as scope creep.',
        },
      ],
    },
  ],
